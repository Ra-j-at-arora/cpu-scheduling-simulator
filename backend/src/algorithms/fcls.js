...
function simulateFCLS(processesInput) {
    ...
    while (completedCount < n) {
        ...
        if (runningProcess === null && readyStack.isEmpty() && processIndex < n) {
            if (currentTime < nextEventTime) {
                timeline.push({
                    time: currentTime,
                    type: EventTypes.IDLE,
                    process: null,
                    queueState: readyStack.toArray(),
                    runningProcess: null
                });
        ...
        if (runningProcess === null && !readyStack.isEmpty()) {
            runningProcess = readyStack.pop();
